...
| Figure | Description |
| :--- | :--- |
| ![Graphical Abstract](Figures/graphical_abstract.png) | **Graphical Abstract**: Visual synthesis of the study. |
| ![Workflow](Figures/fig1_methodology_pipeline.png) | **Methodology Pipeline**: Research workflow overview. |
| ![Trajectories](Figures/fig2_vshape_trajectories_core.png) | **V-Shape Trajectories**: Empirical visualization of patterns. |
| ![Semantic Landscape](Figures/fig3_sbert_semantic_landscape.png) | **Semantic Landscape**: SBERT alignment analysis. |
| ![Correlations](Figures/fig4_metric_correlations_reclamation.png) | **Metric Correlations**: Correlation matrix of metrics. |
| ![Algorithmic Funnel](Figures/fig5_algorithmic_funnel_results.png) | **Algorithmic Funnel**: Dynamics of homogenization. |
