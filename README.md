...
### Research Figures
*   **`fig1_methodology_pipeline.png`**: Methodology overview.
*   **`fig2_vshape_trajectories_core.png`**: Empirical visualization of V-shape patterns.
*   **`fig3_sbert_semantic_landscape.png`**: Semantic alignment analysis.
*   **`fig4_metric_correlations_reclamation.png`**: Correlation matrix of metrics.
*   **`fig5_algorithmic_funnel_results.png`**: The Algorithmic Funnel dynamics.
*   **`graphical_abstract.png`**: Visual synthesis of the study.
